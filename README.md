...
│   │   ├── location.py            # Geolocation & Doctor finder logic
│   │   └── utils.py               # Utility functions & Helpers
│   ├── models/                    # Pre-trained ML Models
│   │   └── trained_model.keras    # TensorFlow/Keras trained model
│   ├── src/                       # Source prediction scripts
...
└── frontend/                      # Next.js React Frontend
    ...
    │   ├── skin-upload.tsx         # Image upload component
    │   ├── prediction-result.tsx   # Results display component
    │   ├── nearby-doctors.tsx      # Doctor finder component
    │   ├── info-section.tsx        # Information section
